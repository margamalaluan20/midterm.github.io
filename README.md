# 🌏 Midterm in Web Development

An interactive and visual encyclopedia built for the **Web Development (WD M01)** Midterm requirements. This application aims to provide comprehensive information about the world of Teyvat using real-time data.

## 🚀 Live Demo
You can access the live website here: [Genshin Impact Archive](https://margamalaluan20.github.io/WD%20M01/index.html)
...
## 📁 Folder Structure
* `index.html`: The main structure of the archive.
